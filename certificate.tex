...
{\setlength{\baselineskip}{1.0\baselineskip}   %set line spacing as 1.5
\begin{quote}
\centerline{This is to certify that the Project Entitled}
\vspace*{.1\baselineskip} 


{\bfseries \fontsize{14}{12} \selectfont \centerline{Automatic Text Categorization of Word Problems}
...
is a bonafide work carried out by Students under the supervision of \textbf{Mrs. Shanthi K. Guru} and it
...
\begin{center}
\begin{quote}
\textbf{Internal Examiner\hspace{25 mm}External Examiner}
\end{quote}
\end{center}
