...
\usepackage{tabularx}
\usepackage{fancyhdr}
\usepackage[left=1.25in, right=1.00in, top=1.00in, bottom=1.00in]{geometry}
%\documentclass{llncs}
\usepackage[title]{appendix}
\usepackage{tikz}
\usetikzlibrary{calc}

\lhead{\fontsize{10.5}{12}\textit{project Report}}
\rhead{\fontsize{10.5}{12}\textit{Automatic Text Categorization of Word Problems}}
\lfoot{\fontsize{10.5}{12}\textit{ Department of Comp. Engg.}}
\cfoot{\thepage}
\rfoot{\fontsize{10.5}{12} \textit{D. Y. Patil COE, Akurdi, Pune}}
...
\pagestyle{fancy}
\pagenumbering{arabic}
\rhead{\textit{Automatic Text Categorization of Word Problems}}
\lhead{\textit{BE Project SEM-II}}
\cfoot{ \thepage}
\lfoot{\textit{D.Y.P.C.O.E., Akurdi, Pune.}}
\rfoot{\textit{Department of Computer Engineering}}
...
\begin{center}
	\begin{figure}[!htbp]
		\centering
		\fbox{\includegraphics[width=\textwidth]{newlogo.png}}
...
\begin{center}
	\begin{figure}[!htbp]
		\centering
		\fbox{\includegraphics[width=230pt]{newlogo.png}}
